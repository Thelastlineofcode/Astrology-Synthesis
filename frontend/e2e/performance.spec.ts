...
test.describe("Performance Tests", () => {
  ...
  test("Dashboard page should load in under 3 seconds (if authenticated)", async ({
    page,
  }) => {
    // Login first
  ...
  test("Fortune calculation should complete in under 1 second (mocked)", async ({
    page,
  }) => {
    await page.goto("/fortune");
  ...
  test("Chat response should arrive in under 3 seconds (target)", async ({
    page,
  }) => {
    await page.goto("/chat");
    await page.waitForLoadState("networkidle");
  ...
  test("Page navigation should be instant (client-side routing)", async ({
    page,
  }) => {
    await page.goto("/");
    await page.waitForLoadState("networkidle");
