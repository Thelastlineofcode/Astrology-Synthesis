 ...
 ***************************************************************************/
#ifndef LIFECYRCLESCOPE_H
#define LIFECYRCLESCOPE_H
...
#include "ui_lifecyrclescope.h"


class LifeCyrcleScopeClass : public StudioWindowClass
{
    Q_OBJECT

public:
    Ui::LifeCyrcleScopeForm         *m_ui;
    ScopeWidgetClass                *scope;
    ScopeWidgetClass                *dataScope;
    
    LifeCyrcleScopeClass(QWidget *parent = 0);
    ~LifeCyrcleScopeClass();
